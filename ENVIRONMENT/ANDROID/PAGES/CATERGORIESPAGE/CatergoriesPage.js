import { CATERGORIESPATH, CATERGORYAPI } from "../../../../API/Api.js";
...
const CATERGORIESPAGE=(DIV)=>{
            ...
            CLEAR(HOMEDIV);
                ...
                REDUX(data,(element)=>{
                    ...
                    CREATEELEMENT('div',(ELEMENT)=>{
                        ...
                        IMAGE(ELEMENT,CATERGORIESPATH+element.Image,'CatergoryImage',()=>{

                            STORE('','MovieCatergory',JSON.stringify(element));
    ...
    DECLARATION('.AppHeader',(ELEMENT)=>{
        ...
        TEXT(ELEMENT,'h2','Catergories','Profile',()=>{})
