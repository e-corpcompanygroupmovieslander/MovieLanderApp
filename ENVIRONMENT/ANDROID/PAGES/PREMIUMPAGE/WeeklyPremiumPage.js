...
const WEEKLYPAYMENT=(DIV)=>{
    ...
    DECLARATION('.Holder',(ELEMENT)=>{
        ...
        TEXT(ELEMENT,'p', `Pay ${sessionStorage.getItem('Amount')}${sessionStorage.getItem('Currency')} Valid For 7 days`,'',()=>{});
    ...
    DECLARATION('.AppHeader',(ELEMENT)=>{
        ...
        TEXT(ELEMENT,'h2','Weekly','Profile',()=>{})
