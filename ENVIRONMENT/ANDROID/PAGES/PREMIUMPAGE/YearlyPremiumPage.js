...
const YEARLYPAYMENT=(DIV)=>{
    ...
    DECLARATION('.Holder',(ELEMENT)=>{
        ...
        BUTTON(ELEMENT,'2 Months Extra',WHITECHECKICON,'',()=>{});

        BUTTON(ELEMENT,'Full Access',WHITECHECKICON,'',()=>{});

        BUTTON(ELEMENT,'OFFLine Access ',WHITECHECKICON,'',()=>{});

        BREAK(ELEMENT);
        
        TEXT(ELEMENT,'p', `Pay ${sessionStorage.getItem('Amount')}${sessionStorage.getItem('Currency')} Valid For One Year`,'',()=>{});
    ...
    DECLARATION('.AppHeader',(ELEMENT)=>{
        ...
        TEXT(ELEMENT,'h2','Yearly','Profile',()=>{})
